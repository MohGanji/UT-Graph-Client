...
export default class ResultPage extends React.Component {
  ...
  render () {
    ...
    if (type === 'user-search') {
      ...
      resultItems = this.state.users.map((user, i) => (
      ...
      changeTypeButton =
        eventsType === 'new' ? (
          <a className="load_more_button" onClick={this.handleTypeChange}>
            مشاهده رویداد های قدیمی
          </a>
        ) : (
          <a className="load_more_button" onClick={this.handleTypeChange}>
            مشاهده رویداد های در حال برگزاری:
          </a>
        );
      resultItems = this.state.events.map((event, i) => (
        <OldEventBox key={i} event={event} />
    ...
    return (
      <div className="container">
        ...
        <div className="search_page_container">
          ...
          <div className="home_new_events_container search_page_results_container">
            {resultItems}
          </div>
